...
# 두 번 쟀다. 큰 쪽을 쓴다 — 문턱을 조이는 쪽이고, v51 자료를 보기 전에 정했다.
#   DS-1  stage3→v50 0.2%p · v50→라운드3 0.5%p
#   DS-2  stage3→v50 13.1%p · v50→라운드3 2.7%p  (이동 자체가 불안정하다)
RUN_SHIFT = {'DS-1': 0.5, 'DS-2': 13.1}
