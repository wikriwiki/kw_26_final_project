...
PLAN = [
    ...
    {'folder': '농축산물할인쿠폰_P016', 'scoring': 'P016',
     ...
     'docs': P016_DOCS, 'env': [],
     'missing': [('정답지 원문',
                  '「2022년 농식품 소비정보 분석사업 결과보고서 Ⅲ — 농축산물 할인지원 사업 '
                  '효과분석」(한국농촌경제연구원, 2022-12-30)은 **원문공개 제한** 자료다. '
                  '발주처인 농림축산식품부 자료실 경유로만 구할 수 있고, 팀이 확보한 사본이 '
                  '노션 「농축산물 할인지원」에 붙어 있다. 서지정보는 '
                  'https://repository.krei.re.kr/handle/2018.oak/30008'),
                 ('2020년 농할쿠폰 시행 보도자료',
...
ANSWER_SOURCE = {
    ...
    'P016': [
        '**정답지가 폴더에 없다.** KREI 보고서가 원문공개 제한이라 팀 노션 사본이 유일한 경로다. '
        '수치(+6.957% · +11.6% · +4.6% · +1.9%p)는 채점표에 옮겨져 있고, 보고서를 직접 열어 '
        '확인하기 전에는 원문 대조가 되지 않는다.',
