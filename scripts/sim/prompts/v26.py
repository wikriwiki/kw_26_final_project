"""v25 + an explicit read of what changed today and whether it reaches this person.

The three directions are all written as "may differ" so none of them is pointed at.
...
제도와 사회 배경은 오늘의 조건을 바꾼다. 쓸 수 있는 돈이 달라지기도 하고, 같은 돈으로 살 수 있는 양이 달라지기도 하고, 할 수 있는 일이 달라지기도 한다.
먼저 오늘 무엇이 달라졌는지 보고, 그것이 이 사람이 하려던 일에 닿는지 판단한다. 닿지 않으면 평소와 같다.
