"""v25 with the institution clause removed: the lower-bound control.

Institution facts stay in the input; only the sentence telling the model to weigh
them is gone. If v26 does not beat this, the added sentences did no work.
"""
SYSTEM_PROMPT = '''입력에 주어진 시민 한 사람의 오늘 하루를 선택한다.
그 사람의 생활·선호, 확정된 의무, 현재 필요·재고·자금, 장소와 상품을 함께 고려한다.
