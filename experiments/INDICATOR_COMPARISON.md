...
|---|---|:-:|---:|---:|---|---|
| P012-1 | 적립업종 지출 (개인 내 쌍체차) | `+` | +20.8 | +131.9 | 부호 일치 | **6.3배** |
| P012-2 | 제외업종 무반응 — 방어선 | `0` | +2.9 | +38.8 | 방어선 — 아래 주석 | — |
...
| EM-3 | 전체 카드매출 증가 (+7.3%) | `+` | +7.3 | +139.8 | 부호 일치 | **19.1배** |
...
| 지표 | 무엇을 재나 | 기대 | 실측 | 시뮬(4런) | 부호 | 크기 |
|---|---|:-:|---:|---:|---|---|
| LV-1 | 소비지출 규모 무반응 — 방어선 | `0` | +0.0 | +44.2 | 방어선 — 아래 주석 | — |
| LV-2 | 거주 행정동 소비 비중 증가 | `+` | 수치 없음 | -3.6 | **부호 반대** | — |
| LV-3 | 타 자치구 소비 비중 감소 | `-` | 수치 없음 | +0.0 | **공허 — 양쪽 팔 모두 0** | — |
...
| 지표 | 무엇을 재나 | 기대 | 실측 | 시뮬(4런) | 부호 | 크기 |
|---|---|:-:|---:|---:|---|---|
| DS-1 | 음식점 지출 감소 (−14.1%) | `-` | -14.1 | +43.3 | **부호 반대** | **3.1배** |
| DS-2 | 소매업 지출 증가 (+4.2%) | `+` | +4.2 | +14.9 | 부호 일치 | **3.5배** |
| DS-3 | 소매 > 음식점 (+4.2 − (−14.1)) | `rank` | +18.3 | -23.5 | **순위 반대** | **1.3배** |
