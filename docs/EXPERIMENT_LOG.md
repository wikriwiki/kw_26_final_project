...
| 지급 | 소비 **1분위 400,000원 / 2분위 300,000원 / 3~10분위 150,000원** (`decile_grants`, `grant_key=spend_decile`) |
...
| 근사·한계 | 기초수급·차상위 자격을 소비 1·2분위로 대응하므로 실제 자격자 비중보다 넓은 근사 · 사용기한 후 잔액은 자동 정산 제외 — P010.json notes |
